# Astrology Birth Chart Parser for Notion

A simple, browser-based tool that converts birth chart data from astro-seek.com into clean tables to streamline the process of copying & pasting the data into Notion databases. No login, no tracking, no API keys required.
...
## ⚠️ Notes
- This tool does **not** connect directly to Notion
- Data must be copy/pasted manually
- Only Astro-Seek’s export format is supported
- Empty fields mean the data was not present in the source text
